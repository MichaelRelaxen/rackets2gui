    ...
    public class Ratchetron : IPS3API
    {
        ...
        public override bool Connect()
        {
            try
            {
                ...
                if (apiRev < 2)
                {
                    Console.WriteLine("The Ratchetron module loaded on your PS3 is too old, you need to restart your PS3 to load the new version.");
                    return false;
                }
        ...
        public void OpenDataChannel()
        {
            ...
            while (!udpStarted)
            {
                ...
                catch (SocketException)
                {
                    if (port++ > 5000)
                    {
                        Console.WriteLine("Tried to open data connection on all ports between 4000 and 5000, but that failed. Did you deny RaCMAN firewall access?");
                        return;
                    }
                }
            }
